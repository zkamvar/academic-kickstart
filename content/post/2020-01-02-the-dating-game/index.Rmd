...
3. The most successful package aside from {base} was {parsedate}, but it's quite
   aggressive in its guessing, substituting the current day, month, and year 
   when it cannot figure out what format the date is in.
...
but even it has drawbacks. All the available packages have their own
idiosyncrasies and it's an absolute minefield when it comes to dates (note that
this doesn't even get into things like [the year 2038
